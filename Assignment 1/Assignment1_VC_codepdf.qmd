...
For this first Assignment, I have selected \textcolor{green}{Brazil}, \textcolor{red}{Angola} and the \textcolor{blue}{United Kingdom} to explore and analyse their *Economic, Social, Environmental, Health, Education, Development and Energy* data.
...
### - \textcolor{green}{Brazil} demographics
...
bra_preview[, `Indicator Code` := NULL]
kable(bra_preview)
...
### - \textcolor{red}{Angola} demographics
...
ago_preview[, `Indicator Code` := NULL]
kable(ago_preview)
...
### - \textcolor{blue}{United Kingdom} demographics
...
gbr_preview[, `Indicator Code` := NULL]
kable(gbr_preview)
...
indicators_keep <- 
  c("Life expectancy at birth, total (years)", 
    "Net migration", "Unemployment, total (% of total labor force) (modeled ILO estimate)")
...
all_data <- rbindlist(list(bra_clean, ago_clean, gbr_clean),
...
summary_stats[,`Indicator Name`:= fcase(
  ...
  "Life Expectancy",  `Indicator Name` == "Net migration", "Net migration",
  `Indicator Name` == 
...
-   Across 6 decades, `Life Expectancy` considerably increased for all 3 countries. Whilst \textcolor{green}{Brazil} and the \textcolor{blue}{United Kingdom} had a consistent exponential gain throughout, \textcolor{red}{Angola} had its major boost in the past 20 years

-   Regarding the `Net Migration`, each country had their own different development, with very unstable peaks throughout the years. The \textcolor{blue}{United Kingdom} presented the highest increase overall, whilst \textcolor{green}{Brazil} kept negative numbers for the vast majority of the years. \textcolor{red}{Angola} on the other hand had its numbers quite stable, until it started to decrease around 2010, reaching a 0 mark in most recent years

-   `Unemployment` data was only captured from the year 1991, showing \textcolor{red}{Angola} with the highest incidence of unemployed people. The \textcolor{blue}{United Kingdom} and \textcolor{green}{Brazil} numbers varied, with many high and low peaks in different years.

## Cross-Country Comparison

Giving a closer look into the indicators in the past year, the database for these 3 countries have demonstrated:

-   The \textcolor{blue}{United Kingdom} have had the *highest* `Net Migration`, but the *lowest* `Unemployment` rate

-   \textcolor{green}{Brazil} was the country with *lowest* `Net Migration`, however with an *average* `Unemployment` rate

-   \textcolor{red}{Angola} barely presented `Net Migration` in 2024, with its rate *close to 0*, compensating in its `Unemployment` rate which was the *highest* among all countries.

# Conclusion

-   Compiling both analysis made for this assignment, an overall difference in the demographics of all 3 countries is noted. The results exemplify the development of countries like the \textcolor{blue}{United Kingdom}, the slow progress of \textcolor{green}{Brazil} and the under development of an African nation like \textcolor{red}{Angola}

-   A special mention to the reflection of the **Covid-19 pandemic break in 2020**, where `Net Migration` differed in the \textcolor{blue}{United Kingdom} (with a drastic decrease) and a big peak in \textcolor{green}{Brazil}. Also, with a massive peak in Unemployment in all 3 countries.
